        ...
        <div className="relative items-center w-full py-12 lg:py-20">
          <div className="text-center">
            <span className="text-sm text-primary font-medium tracking-tight bg-primary/10 px-4 py-2 rounded-full">
              Platform for Programming Articles
            </span>
            ...
            <p className="max-w-xl mx-auto mt-4 text-base font-light lg:text-lg text-muted-foreground tracking-tighter">
              Create and publish programming articles, tutorials, and coding guides. Share your technical knowledge with developers worldwide.
            </p>
